...
export const SENTENCES: Sentence[] = [
...

  {
    ...
    categoryId: "numbers",
    translations: {
      en: { tokens: ["What", "time", "is", "it?"] },
      es: { tokens: ["¿Qué", "hora", "es?"] },
      de: { tokens: ["Wie", "spät", "ist", "es?"] },
      it: { tokens: ["Che", "ore", "sono?"] },
      ja: { tokens: ["今", "何時", "ですか?"], romanization: ["Ima", "nanji", "desu ka?"] },
      tl: { tokens: ["Anong", "oras", "na?"] },
      ru: { tokens: ["Который", "час?"], romanization: ["Kotoryy", "chas?"] },
      fr: { tokens: ["Quelle", "heure", "est-il?"] },
      pt: { tokens: ["Que", "horas", "são?"] },
      ar: { tokens: ["كم", "الساعة؟"], romanization: ["Kam", "as-sa'ah?"] },
    },
  },
  {
    id: "numbers-2",
    categoryId: "numbers",
    translations: {
      en: { tokens: ["It", "is", "three", "o'clock."] },
      es: { tokens: ["Son", "las", "tres."] },
      de: { tokens: ["Es", "ist", "drei", "Uhr."] },
      it: { tokens: ["Sono", "le", "tre."] },
      ja: { tokens: ["三時", "です。"], romanization: ["Sanji", "desu."] },
      tl: { tokens: ["Alas", "tres", "na."] },
      ru: { tokens: ["Сейчас", "три", "часа."], romanization: ["Seychas", "tri", "chasa."] },
      fr: { tokens: ["Il", "est", "trois", "heures."] },
      pt: { tokens: ["São", "três", "horas."] },
      ar: { tokens: ["الساعة", "الثالثة."], romanization: ["As-sa'atu", "ath-thalithah."] },
    },
  },
  {
    id: "numbers-3",
    categoryId: "numbers",
    translations: {
      en: { tokens: ["I", "have", "two", "brothers."] },
      es: { tokens: ["Tengo", "dos", "hermanos."] },
      de: { tokens: ["Ich", "habe", "zwei", "Brüder."] },
      it: { tokens: ["Ho", "due", "fratelli."] },
      ja: { tokens: ["私には", "兄弟が", "二人", "います。"], romanization: ["Watashi ni wa", "kyoudai ga", "futari", "imasu."] },
      tl: { tokens: ["May", "dalawa", "akong", "kapatid", "na", "lalaki."] },
      ru: { tokens: ["У", "меня", "два", "брата."], romanization: ["U", "menya", "dva", "brata."] },
      fr: { tokens: ["J'ai", "deux", "frères."] },
      pt: { tokens: ["Eu", "tenho", "dois", "irmãos."] },
      ar: { tokens: ["لدي", "أخوان."], romanization: ["Ladayya", "akhawan."] },
    },
  },
  {
    id: "numbers-4",
    categoryId: "numbers",
    translations: {
      en: { tokens: ["The", "meeting", "starts", "at", "nine."] },
      es: { tokens: ["La", "reunión", "empieza", "a", "las", "nueve."] },
      de: { tokens: ["Die", "Besprechung", "beginnt", "um", "neun."] },
      it: { tokens: ["La", "riunione", "inizia", "alle", "nove."] },
      ja: { tokens: ["会議は", "九時に", "始まります。"], romanization: ["Kaigi wa", "kuji ni", "hajimarimasu."] },
      tl: { tokens: ["Magsisimula", "ang", "miting", "nang", "alas", "nuwebe."] },
      ru: { tokens: ["Встреча", "начинается", "в", "девять."], romanization: ["Vstrecha", "nachinayetsya", "v", "devyat'."] },
      fr: { tokens: ["La", "réunion", "commence", "à", "neuf", "heures."] },
      pt: { tokens: ["A", "reunião", "começa", "às", "nove."] },
      ar: { tokens: ["يبدأ", "الاجتماع", "في", "الساعة", "التاسعة."], romanization: ["Yabda'u", "al-ijtima'u", "fi", "as-sa'ati", "at-tasi'ah."] },
    },
  },
  {
    id: "numbers-5",
    categoryId: "numbers",
    translations: {
      en: { tokens: ["Today", "is", "Monday."] },
      es: { tokens: ["Hoy", "es", "lunes."] },
      de: { tokens: ["Heute", "ist", "Montag."] },
      it: { tokens: ["Oggi", "è", "lunedì."] },
      ja: { tokens: ["今日は", "月曜日", "です。"], romanization: ["Kyou wa", "getsuyoubi", "desu."] },
      tl: { tokens: ["Lunes", "ngayon."] },
      ru: { tokens: ["Сегодня", "понедельник."], romanization: ["Segodnya", "ponedel'nik."] },
